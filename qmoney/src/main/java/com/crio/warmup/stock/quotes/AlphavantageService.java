...
public class AlphavantageService implements StockQuotesService {
  ...
  public static final String TOKEN = "Y35IB6XID854FX71";
  ...
  protected String buildUrl(String symbol){
    String UrlTemp = String.format("https://www.alphavantage.co/query?function=%s&symbol=%s&apikey=%s",FUNCTION,symbol,TOKEN);
    return UrlTemp;
  }
